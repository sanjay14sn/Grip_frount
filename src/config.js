...
export const IMAGE_BASE_URL = process.env.REACT_APP_IMAGE_URL || "https://api.gripforum.com/api/public/";
export const BASE_URL = process.env.REACT_APP_API_BASE_URL || "https://api.gripforum.com/api/mobile";
export const server = process.env.REACT_APP_SERVER_URL || "https://api.gripforum.com/";
